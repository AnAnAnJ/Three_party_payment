...
class Test_Query_goods():
            ...
            try:
                res = requests.post(url=self.viva_host_url + uri,
                                    headers={
                                                ...
                                                'Z-Lat': '0',
                                                'Z-Language': 'en-us',
                                                'Z-User-Agent': f'{page_name}/1.2.0 iOS/18.6.2 (iPhone 14)',
                ...
                if (res.headers.get('Z-Auth-Token')) != None:
                    ...
                    return Project,page_name,viva_token
    ...
    # 查询商品
    def test_goods(self,Project,page_name):
        if Project == "viva":
            ...
            try:
                res = requests.get(url=self.viva_host_url + uri,
                                   headers={
                                                'Z-App-Info': 'bundle_id=com.swerlzenfigmaderlas.swerl;version=1.3.0;build=13',
                                                'Z-Auth-Token': self.test_login().viva_token,
                                                'Z-Client-Id': '4886037297291990',
                                                'Z-Lon': '0',
                                                'Z-Lat': '0',
                                                'Z-Language': 'en-us',
...
if __name__ == '__main__':
    Test_Query_goods().test_login(Project="viva",page_name="Drift")
    Test_Query_goods().test_goods(Project="joymeet",page_name="oooo")
